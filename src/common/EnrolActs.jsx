   ...
   useEffect(() => {
	...
	return (
		<div className='flex flex-col justify-center p-4 mb-4'>
			<div className="flex felx-wrap gap-3 pb-2">
               ...
               defaultValue=''
				...
				<div className="md:w-1/4">
					<label className="block text-sm font-normal pb-2">Enrollment Certificate Number<span className="text-red-600 font-normal">*</span></label>
					<input
						type="text"
            ...
            <div className="md:w-1/4">
					<label className="block text-sm font-normal pb-2">Date of Issue<span className="text-red-600 font-normal">*</span></label>
					<input
						type="date"
						name="logDate"
