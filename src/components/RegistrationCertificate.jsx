...
import PrintRegistrationCertificate from './PrintRegistrationCertificate';

const RegistrationCertificate = (props) => {
               ...
               <div className='flex flex-col w-full rounded bg-white shadow-md'>
                  ...
                  <div className='flex-col flex p-8 tracking-wider leading-loose'>
                     ...
                     <div className="flex-row flex-wrap flex gap-6 pt-6 text-justify">
                        ...
                        <p>Name: <span className="shadow border bg-stone-50 shadow-stone-50 py-1 px-4 rounded">{body.applicantName}</span></p>
